...
An island game-show night for 2 to 10 castaways in the browser. No downloads: join with a link and a 4-letter code. Ten quick challenges, the host picks which game is next (or hits "Surprise me"), points for every finish, a torch leaderboard between games, and one Island Champion at the end. The host can end the season any time and crown the leader.
...
9. **THE STAMPEDE**: a Mario-Party-style grid arena. Two players ride elephants: four squares big, slow, with a charge that smashes boulders. Everyone else is small and quick, slipping through one-square gaps the elephants can't fit. Get stepped on = pancake. Squashes and survival both score, and everyone gets a round on elephant-back.
10. **OFF THE ROCK**: sumo free-for-all on a shrinking rock over the sea. Lean into people to push (gang-ups stack), BUMP for a quick shove, CHARGE for a haymaker, and DODGE a charge at the right moment to send the charger stumbling past you into the water. Last one dry wins; knockouts score extra. Three rounds.

Scoring: 1st place 10, then 7, 5, 4, 3, 2, 1. Ties share the better points. Most points when the host ends the season takes the Cup.
