...
function renderJoin(): void {
  ...
  join.innerHTML = `
    ...
    <div class="card">
      ...
      <div class="hint">A game-show night for 6 friends: eight quick challenges, points for every finish,
      ...
      ${
        isHost
          ? `<button id="l-start" ${n < MIN_PLAYERS ? 'disabled' : ''}>🔥 Light the torches (${n} castaways)</button>
             <div class="hint" style="text-align:center">Eight challenges. Points every game. Most points takes the Cup.</div>`
